  ...
  render() { 
    return (
      ...
      <div className="portfolio-item">
          <Link className="portfolio-link" data-bs-toggle="modal" to={`/blog/${this.props.post.slug}`}>
              <div className="portfolio-hover">
                  <div className="portfolio-hover-content"><i className="fas fa-plus fa-3x"></i></div>
              </div>
              {this.props.post.PostImage ?
                this.props.post.PostImage.length > 0 ?
              <img className="img-fluid" src={API.makeFileURL(this.props.post.PostImage[0].thumbnail, null)} alt="..." />
              : null
              : null}
          </Link>
